...
const AudioUploader = ({ onAudioSelected, onEffectSelected }) => {
  ...
  const soundEffects = [
    { name: "Fart 1", url: "/sound_effects/perfect-fart.mp3", file: "perfect-fart" },
    { name: "Fart 2", url: "sound_effects/dry-fart.mp3", file: "dry-fart" },  
    { name: "Quack", url: "/sound_effects/quack_5.mp3" , file: "quack_5" },
  ];
